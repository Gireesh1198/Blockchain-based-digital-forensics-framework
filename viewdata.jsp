...
<body>
	...
	<div id="background">
		<div id="page">
			...
			<div id="contents">
                            <div>
                                        <center><h1>View Block Chained Data</h1><br>
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
                                    ...
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;&nbsp;&nbsp;View Data</strong></b>&emsp;</td>   
         </tr>
                               <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
...
<%  Connection con= DB.Con();
    try{
        String status="";
                        PreparedStatement ps=con.prepareStatement("select * from data where status='Converted' ");
                        ResultSet rs=ps.executeQuery();
                                ...
                                <tr>
                                    ...
                                    <td align="center"><a style="color:red;font-weight: bold;" href="view.jsp?id=<%=rs.getString("id")%>" >Click Here</a></td>
