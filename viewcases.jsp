...
<body>
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
                                    ...
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;&nbsp;&nbsp;View Full Report Data</strong></b>&emsp;</td>   
         </tr>
                               <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
        ...
        String status="";
                        ...
                        ResultSet rs=ps.executeQuery();
                                ...
                                <tr>
                                    ...
                                    <td align="center"><a style="color:red;font-weight: bold;" href="viewcase.jsp?id=<%=rs.getString("id")%>" >Click Here</a></td>
