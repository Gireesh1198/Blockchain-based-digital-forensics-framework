...
<body>
	...
	<div id="background">
		<div id="page">
			...
			<div id="contents">
				<div id="main"> 
                                    <br><center><h1 style='color: white;'>View Block Chained Datas</center></h1>
                                    <br>&emsp;&emsp;&emsp;&emsp;<span style="font-size: 20px;">Case Id &emsp;&emsp;&emsp;&nbsp;</span><input type="text" name="cid" value="<%=caseid%>" readonly="">
                                            ...
                                            <center><textarea name="modify" cols="60" rows="15"><%=dataset%></textarea></center>       
                                            <br>&emsp;&emsp;&emsp;&emsp;<span style="font-size: 20px;">IP Address &emsp;&emsp;</span><input type="text" name="ip" value="<%=ip%>" readonly=""><br>
                                            <br><br>
                                            <form action="viewOriginal.jsp" method="post">
                                                <input type="hidden" name="id" value="<%=id%>">
                                                &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                                                &emsp;&emsp;&emsp;&emsp;&emsp;
                                                <input type="submit"  style="height:30px;" value="Get Original Data's">
                                            </form>
                                         <br><br>   
